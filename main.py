...
layout = [[sg.Text('Window Selection: ')],
          ...
          [sg.Text("X Pos:"),sg.InputText("0", size=(7,7),key='X'),sg.Text("Y Pos:"),sg.InputText("0", size=(7,7),key='Y')],
          [sg.Text("H Res:"),sg.InputText("2560", size=(7,7),key='HRes'),sg.Text("V Res:"),sg.InputText("1440", size=(7,7),key='VRes')],
          [sg.Button('Borderless Window'), sg.Button('Revert Changes'), sg.Button('Resize/Position', key="Resize"), sg.Exit(key='Cancel')]
          ]
